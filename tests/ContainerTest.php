...
class ContainerTests extends TestCase
{
    ...
    public function testDeleteRemovesDefinitions()
    {
        $c = new Container();
        $c->register(TestObj::class);
        $c->delete(TestObj::class);

        $this->expectException(NotFoundException::class);
        $this->expectExceptionMessage('Callback for "' . TestObj::class . '" does not exist.');
